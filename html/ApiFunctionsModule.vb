...
Public Function CreateSubSection(sectionId As String, _
    ...
    jsonBody = "{" & _
        ...
        """unitCostInCalculatedUnits"": " & ToInvariantString(unitCostInCalculatedUnits) & "," & """groupOfWork"": """ & groupOfWork & """" & _
        "}"
...
Public Function CreateSubSubSectionItem(subSubSectionId As String, _
    ...
    jsonBody = "{" & _
        ...
        """totalResourceCost"": " & ToInvariantString(totalResourceCost) & "," & """groupOfWork"": """ & groupOfWork & """" & _
        "}"
